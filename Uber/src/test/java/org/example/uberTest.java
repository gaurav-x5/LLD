...
public class uberTest {
    ...
    @BeforeEach
    void setUp() {
        CabsManager cabsManager = new CabsManagerImpl();
        RidersManager ridersManager = new RidersManagerImpl();
        ...
        TripsManager tripsManager = new TripsManagerImpl(cabsManager, ridersManager, cabMatchingStrategy, pricingStrategy);
